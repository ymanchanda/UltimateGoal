...
public class SampleMecanumDrive extends MecanumDrive {
    public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(0, 0, 0);//15,0,1
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(8, 0, 0);//8,0,1
